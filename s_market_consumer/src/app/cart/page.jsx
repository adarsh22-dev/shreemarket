...
import { getAllProducts } from '@/lib/api/client';
            ...
            <div className="cart-page-container">
                    ...
                    <aside className="cart-sidebar">
                        ...
                        <div className="order-summary-card">
                            ...
                            {cartCount === 0 ? (
                                ...
                                <Link href="/checkout" className="btn-checkout" style={{ textAlign: 'center', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                                    Proceed to Checkout
                                </Link>
                            )}
                ...
                <section className="suggestions-section">
                    <div className="suggestions-header">
                        ...
                        <Link href="/shop" className="view-more-link">
                    ...
                    <div className="suggestions-grid">
                        {loadingSuggestions ? (
                            ...
                            suggestedProducts.map((product) => (
                                <Link key={product.id} href={`/product/${product.id}`} className="suggestion-card">
