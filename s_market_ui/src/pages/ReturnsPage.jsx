...
const eligibilityItems = [
  { label: "Timeframe", text: "Items can be returned or exchanged within 30 days of delivery." },
  { label: "Condition", text: "Products must be unused, in original packaging, and in the same condition as received." },
  { label: "Eligible Items", text: "Most items are eligible except personalized products, gift cards, and final sale items." },
  { label: "Proof of Purchase", text: "A receipt or order confirmation is required for all returns and exchanges." },
];

const returnSteps = [
  { title: "Contact Us", text: "Email support@example.com or call 1-800-123-4567 to request an RMA number. Provide your order number and reason for return." },
  { title: "Package Your Item", text: "Securely pack the item in its original packaging, including all accessories, manuals, and documentation. Include a copy of your receipt." },
  { title: "Label the Package", text: "Attach the provided return shipping label and clearly mark the RMA number on the outside of the package." },
  { title: "Ship the Package", text: "Drop off at an authorized carrier (USPS, FedEx, etc.). Use a trackable shipping method — we are not responsible for lost shipments." },
  { title: "Confirmation", text: "Once received and inspected, we'll notify you by email. Approved refunds are processed within 5–7 business days to the original payment method." },
];
    ...
    return (
      <div>
        ...
        <div className="returns-page">
          ...
          <section className="returns-section" style={{ padding: "2rem 1rem", maxWidth: "800px", margin: "0 auto" }}>
  ...
  return (
    <div>
      ...
      <div className="returns-page">
        ...
        {loading ? (
          <section className="returns-section" style={{ textAlign: "center", padding: "2rem" }}><p>Loading...</p></section>
        ) : (
          <>
            ...
            <section className="returns-section">
              <h2>Refunds</h2>
              <ul className="info-list">{refundItems.map((item, i) => (<li key={i}>{item}</li>))}</ul>
            </section>

            <section className="returns-section">
              <h2>Exceptions</h2>
              <ul className="info-list">{exceptionItems.map((item, i) => (<li key={i}>{item}</li>))}</ul>
            </section>
