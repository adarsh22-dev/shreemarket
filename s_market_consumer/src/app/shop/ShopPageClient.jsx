...
const ShopPageClient = ({ products, initialCategory, initialSearch }) => {
            ...
            <main className="shop-page-main">
                ...
                <header className="shop-header">
                    <div className="shop-breadcrumbs">
                        <Link href="/">Home</Link> <span className="separator">&gt;</span> <span className="current">Shop All</span>
                    </div>
                </header>
                        ...
                        <div className="filter-section">
                            ...
                            <div className="price-inputs-row">
                                <input
                                    ...
                                    min="0"
                                />
                                <span className="price-separator">&mdash;</span>
                                <input
                                    type="number"
                                    className="price-input"
                                    placeholder="Max &#8377;"
                        ...
                        <div className={`shop-products ${viewMode}`}>
                            {loading ? (
                                ...
                                paginatedProducts.map(product => {
                                    ...
                                    return (
                                        <Link href={`/product/${product.id}`} key={product.id} className="shop-product-card" style={{ textDecoration: 'none', color: 'inherit' }}>
