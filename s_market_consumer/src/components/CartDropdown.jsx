...
const BACKEND_URL = process.env.NEXT_PUBLIC_API_BASE_URL?.replace('/api', '') || 'http://localhost:8082';
                ...
                <div className="cart-items-list">
                    {cartItems.length === 0 ? (
                        <div className="empty-cart-message">
                            Your cart is empty.
                            <br />
                            <Link href="/shop" onClick={closeCart}>Start Shopping</Link>
                        </div>
                    ) : (
                ...
                {cartItems.length > 0 && (
                    <div className="cart-footer">
                        ...
                        <div className="cart-actions">
                            <Link href="/checkout" className="btn-checkout" style={{ display: 'block', textAlign: 'center', textDecoration: 'none' }} onClick={closeCart}>Checkout</Link>
                            <Link href="/cart" className="btn-view-cart" onClick={closeCart} style={{ display: 'block', textAlign: 'center', textDecoration: 'none' }}>View Cart</Link>
                            <Link href="/wishlist" className="btn-view-wishlist" onClick={closeCart} style={{ display: 'block', textAlign: 'center', textDecoration: 'none', marginTop: '8px', color: '#666', fontSize: '0.9rem' }}>Go to Wishlist</Link>
                        </div>
                    </div>
                )}
            </div>
