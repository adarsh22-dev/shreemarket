...
const dataTypes = [
  {
    ...
    desc: "Details you provide when placing orders, creating an account, writing reviews, or contacting us.",
  },
  {
    icon: "",
    label: "Automatic Information",
    desc: "Data collected automatically when you browse — including cookies, IP address, device type, and usage patterns.",
  },
  {
    icon: "",
    label: "Information from Other Sources",
    desc: "Updated delivery details from carriers, account data from co-branded partners, and credit history from bureaus.",
  },
  {
    icon: "",
    label: "Location & Device Data",
    desc: "Location information, device identifiers, and connectivity data used to improve services and detect fraud.",
  },
];
...
const purposes = [
  {
    ...
    desc: "To take and fulfill orders, process payments, and communicate about your purchases.",
  },
  {
    title: "Service Improvement",
    desc: "To analyze performance, fix errors, and improve the usability of our services.",
  },
  {
    title: "Personalization",
    desc: "To recommend products and personalize your experience based on your preferences.",
  },
  {
    title: "Legal Compliance",
    desc: "To comply with applicable laws, including identity verification for sellers.",
  },
  {
    title: "Communication",
    desc: "To contact you via phone, email, or chat regarding your account and services.",
  },
  {
    title: "Fraud Prevention",
    desc: "To detect and prevent fraud, abuse, and assess credit risks to protect all users.",
  },
];
      ...
      <div className="terms-page" id="top">
        ...
        <section className="terms-section" id="personal-info">
          ...
          <p>
            ...
            improve our products and services. The types of information we
            collect fall into the following categories:
          </p>
        ...
        <section className="terms-section" id="purposes">
          ...
          <p>
            We use your personal information to operate, develop, and improve
            our services. Key purposes include:
          </p>
        ...
        <section className="terms-section" id="cookies">
          ...
          <div className="highlight-box">
            <p>
              To recognize your browser or device and improve our services, we
              use cookies and other identifiers. These allow us to enable
              shopping cart functionality, remember your preferences, and
              provide a personalized experience. Disabling cookies may prevent
              certain features from working, including checkout and sign-in.
            </p>
          </div>
          <p>
        ...
        <section className="terms-section" id="advertising">
          ...
          <div className="highlight-box">
            <p>
              We may display interest-based ads using identifiers such as
              cookies or device IDs — never your name or directly identifying
              details. Third-party ad partners may also collect information
              when you interact with their content on our platform.
            </p>
          </div>
          <p>
            You can adjust your advertising preferences at any time through
            the Advertising Preferences page in your account settings.
          </p>
          <a href="#top" className="back-to-top">↑ Back to Top</a>
        </section>
        ...
        <section className="terms-section" id="your-choices">
          <h2>Your Choices</h2>
          <p>
            You have meaningful control over how your personal information is
            used. Here are your options:
          </p>
          <ul className="terms-list">
        ...
        <section className="terms-section" id="children">
          ...
          <div className="highlight-box">
            <p>
              We do not sell products for direct purchase by children. Children's
              products are intended to be purchased by adults. If you are under
              18 years of age, you may use our services only with the involvement
        ...
        <section className="terms-section" id="revisions">
          ...
          <p>
            Your use of our services and any privacy-related disputes are
            subject to this Notice and our Conditions of Use, including
            limitations on damages and applicable law.
          </p>
          <p>
            Our business evolves, and this Privacy Notice may change over time.
            We encourage you to review it periodically. We will never materially
            reduce the protections applied to previously collected information
        ...
        <section className="terms-section" id="grievance">
          <div className="contact-dark-box">
            ...
            <p style={{ marginTop: '8px' }}>
              For privacy concerns or data requests, please reach out to our
            ...
            <div className="grievance-grid">
              ...
              <div className="grievance-item" style={{ gridColumn: '1 / -1' }}>
                ...
                <p>
                  Amazon Seller Services Pvt. Ltd., 14th Floor, Block–E,
