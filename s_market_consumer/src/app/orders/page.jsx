...
import { fetchUserOrders, createMockOrder, getAllProducts, submitProductReview, getUserReviews, submitReturnAPI } from '@/lib/api/client';
...
const OrdersPage = () => {
    ...
    const handleSubmitReview = async (e) => {
        ...
        try {
            const rawUserId = authUser?.id || userId;
            ...
            const reviewJson = {
                ...
                reviewerName: authUser?.fullName || "Valued Customer",
